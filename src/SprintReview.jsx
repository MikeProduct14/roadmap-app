...
function calculateMetrics(tasks, sprint) {
  ...
  const loggedHours = sprintTasks.reduce(
    (sum, t) => sum + (t.timeLog || []).reduce((s, log) => s + log.hours, 0),
    0
  )
      ...
      <div style={s.section}>
        ...
        <div style={s.metricRow}>
          ...
          <span style={s.metricValue}>
            {metrics.completed} / {metrics.totalTasks}
          </span>
        </div>
        ...
        <div style={s.metricRow}>
          ...
          <span style={{ ...s.metricValue, color: metrics.overdue > 0 ? '#E24B4A' : 'var(--tx)' }}>
            {metrics.overdue}
          </span>
        </div>
        ...
        <div style={s.metricRow}>
          ...
          <span style={s.metricValue}>
            {metrics.loggedHours} / {metrics.totalHours} ч
          </span>
        </div>
            ...
            .map((h, i) => (
              <div key={i} style={s.historyItem}>
                ...
                <div style={s.historyMetrics}>
                  <div>
                    Завершено: {h.completed}/{h.totalTasks}
                  </div>
