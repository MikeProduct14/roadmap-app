  ...
  return (
    <div style={s.container}>
      ...
      <div style={s.section}>
        ...
        <p style={s.p}>
          Ретро — это встреча команды в конце спринта, где все честно говорят что было круто, что не
          очень, и как сделать следующий спринт еще лучше. Без обвинений, только конструктив и
          улучшения.
        </p>
      </div>
      ...
      <div style={s.section}>
        ...
        <div style={s.card}>
          ...
          <div style={s.cardText}>
            Соберите всю команду. Включите камеры, выключите уведомления. Создайте доску (Miro,
            FigJam или просто Google Doc) с тремя колонками.
          </div>
        </div>
        ...
        <div style={s.card}>
          ...
          <div style={s.cardText}>
            ...
            <br />
            <br />
            Пишите конкретно: не "плохая коммуникация", а "не было дейли в понедельник и мы
            дублировали работу".
          </div>
        </div>
        ...
        <div style={s.card}>
          ...
          <div style={s.cardText}>
            Каждый зачитывает свои стикеры. Группируйте похожие темы. Обсуждайте без обвинений —
            фокус на процессе, а не на людях.
            <br />
            <br />
        ...
        <div style={s.card}>
          ...
          <div style={s.cardText}>
            Зафиксируйте action items в таск-трекере. Поблагодарите команду за честность. Можно
            закончить чем-то позитивным — например, каждый говорит кого хочет отметить за спринт.
          </div>
        </div>
      </div>
      ...
      <div style={s.section}>
        ...
        <div style={s.card}>
          ...
          <div style={s.cardText}>Каждый ставит оценку спринту от 1 до 10 и объясняет почему</div>
        </div>
      ...
      <div style={s.section}>
        ...
        >
          Ретро — это безопасное пространство. Что обсуждается на ретро, остается на ретро. Никаких
          последствий за честность. Иначе люди перестанут говорить правду, и встреча превратится в
          пустую формальность.
        </p>
      </div>
    </div>
